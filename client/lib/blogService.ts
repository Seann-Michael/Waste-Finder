...
const sampleCategories: Omit<BlogCategory, 'id' | 'created_at' | 'updated_at'>[] = [];
...
export function initializeBlogData(): void {
  console.warn('initializeBlogData is deprecated - use Supabase for blog management');
}
 ...
 */
export async function getBlogPosts(params: BlogSearchParams = {}): Promise<BlogSearchResponse> {
  console.warn('getBlogPosts is deprecated - use Supabase client to fetch blog posts');
  return {
    posts: [],
    categories: [],
    total: 0,
...
export async function getBlogPost(slug: string): Promise<BlogPost | null> {
  console.warn('getBlogPost is deprecated - use Supabase client to fetch blog post');
  return null;
}
...
export async function getBlogCategories(): Promise<BlogCategory[]> {
  console.warn('getBlogCategories is deprecated - use Supabase client to fetch categories');
  return [];
}
...
export async function getFeaturedPosts(limit: number = 5): Promise<BlogPost[]> {
  console.warn('getFeaturedPosts is deprecated - use Supabase client to fetch featured posts');
  return [];
}
...
export async function getRecentPosts(limit: number = 5): Promise<BlogPost[]> {
  console.warn('getRecentPosts is deprecated - use Supabase client to fetch recent posts');
  return [];
}
...
export async function getRelatedPosts(currentPostId: string, limit: number = 3): Promise<BlogPost[]> {
  console.warn('getRelatedPosts is deprecated - use Supabase client to fetch related posts');
  return [];
}
