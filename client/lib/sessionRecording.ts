...
export function initSessionRecording() {
  const config: SessionRecordingConfig = {
    provider: (import.meta.env.VITE_SESSION_RECORDING_PROVIDER as any) || 'disabled',
    siteId: import.meta.env.VITE_SESSION_RECORDING_SITE_ID,
    apiKey: import.meta.env.VITE_SESSION_RECORDING_API_KEY,
    samplingRate: parseFloat(import.meta.env.VITE_SESSION_RECORDING_SAMPLE_RATE || '0.1'),
  };
...
function initFullStory(orgId: string) {
  ...
  (function(m: any, n: any, e: any, t: any, l: any, o: any, g: any, y: any) {
    ...
    g.identify = function(i: any, v: any, s: any) { g(l, { uid: i }, s); if (v) g(l, v, s); }; g.setUserVars = function(v: any, s: any) { g(l, v, s); };
    g.event = function(i: any, v: any, s: any) { g('event', { n: i, p: v }, s); }; g.anonymize = function() { g.identify(!!0); };
    g.shutdown = function() { g('rec', !1); }; g.restart = function() { g('rec', !0); };
    g.log = function(a: any, b: any) { g('log', [a, b]); }; g.consent = function(a: any) { g('consent', !arguments.length || a); };
...
function initLogRocket(appId: string) {
  ...
  lr.init = lr.init || function(appId: string) {
 ...
 */
export function trackSessionEvent(eventName: string, properties?: Record<string, any>) {
  // Hotjar
