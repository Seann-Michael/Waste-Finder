        ...
        {isAdmin && (
          <div className="bg-yellow-500 text-black py-2 px-4 text-center text-xs font-medium">
            <div className="flex items-center justify-center gap-2 whitespace-nowrap">
              ...
              <span className="flex-shrink-0">ADMIN MODE - You are logged in as administrator</span>
              <Link to="/admin" className="underline hover:no-underline font-semibold flex-shrink-0">
