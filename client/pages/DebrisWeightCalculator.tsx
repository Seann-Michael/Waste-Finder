                        ...
                        <div className="absolute z-10 w-full mt-1 bg-white border border-blue-300 rounded-md shadow-lg max-h-60 overflow-y-auto">
                          {isLoadingTypes ? (
                            ...
                            filteredItems.map((debris) => (
                              ...
                              >
                                <div className="flex items-center gap-3">
                                  <span className="text-xl">{debris.iconEmoji || debris.icon || "🔲"}</span>
                                  <div className="flex-1">
                                    <div className="font-medium text-blue-800">
                                      {debris.name}
                                    </div>
                                    <div className="text-sm text-blue-600">
                                      {debris.weightPerUnit.toLocaleString()} lbs per {debris.unit} • {debris.category}
                                    </div>
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <div className="text-sm text-green-600">
                              {selectedDebris.weightPerUnit.toLocaleString()} lbs per {selectedDebris.unit}
                            </div>
                          </div>
                        </div>
                      </div>
                  ...
                  {(pounds || yards) && selectedDebris && (
                    <div className="bg-gradient-to-r from-green-500 to-blue-500 text-white rounded-xl p-6 mt-6">
                      ...
                      <div className="text-center mt-4 text-green-100 text-sm">
                        Using {selectedDebris.name}: {(selectedDebris.weightPerUnit / selectedDebris.volumePerUnit).toFixed(0)} lbs/yd³
                      </div>
                    </div>
                  )}
