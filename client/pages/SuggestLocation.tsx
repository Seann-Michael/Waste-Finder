        ...
        <div className="max-w-2xl mx-auto px-4 py-16">
          <Card>
            <CardContent className="pt-8 text-center">
              ...
              <h2 className="text-2xl font-bold mb-4">Suggestion Submitted!</h2>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">
            Help us expand our database by suggesting a waste disposal facility
            that's not currently listed. All submissions are reviewed by our
            team.
          </p>
        </div>
